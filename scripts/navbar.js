        ...
        <div class="container">
            ...
            <div class="nav-links">
                <ul class="menu">
                    ...
                    <li><a href="#" id ="notificationsButton">Notification</a></li>
                    <li><a href="#">Profile</a></li>
                </ul>
                <br>
                <div class="auth-buttons">
                    <a href="../sign_in/sign_in.html" class="btn-signin">Sign in</a>
                    <a href="../sign_up/sign_up.html" class="btn-register">Sign up</a>
                </div>
            </div>
        </div>
    </nav>`;
